...
export default () => ({
    app: {
        ...
        apiUrl: process.env.APP_API_URL || "http://localhost:8080",
        ...
        emailVerifyUrl: `${process.env.APP_API_URL || "http://localhost:8080"}/${process.env.APP_EMAIL_VERIFY_PATH || "auth/verify-email"}`,
